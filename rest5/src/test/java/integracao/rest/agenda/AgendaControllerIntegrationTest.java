...
{	@Autowired
	...
	@After public void end() {contatoRepository.deleteAll();}

	/*Veremos as mensagens de erro ao alterar um contato existente.*/
	@Test public void alterarDeveRetornarMensagemDeErro() 
	{	contato.setDdd(null);
	...
	/*Veremos se a edição de um contato valido esta funcionando*/
	@Test public void alterarDeveAlterarContato() 
	{	contato.setNome("Novo Chefe");
		HttpEntity<Contato> httpEntity = new HttpEntity<>(contato);
		ResponseEntity<Contato> resposta = 
				testRestTemplate.exchange("/agenda/alterar/{id}",
	...
	@Test public void alterarDeveAlterarContatoComPut() 
	{	contato.setNome("Novo Chefe");
	...
	@Test public void removerDeveExcluirContato() 
	{	ResponseEntity<Contato> resposta = 
				testRestTemplate.exchange(
						"/agenda/remover/{id}",HttpMethod.DELETE,null
						, Contato.class,contato.getId());
	...
	@Test public void removerDeveExcluirContatoComDelete() 
