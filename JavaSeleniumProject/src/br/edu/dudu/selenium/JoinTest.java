...
{	public static void main(String[] args) 
	{	//atributos de classe
		...
		{	driver.get("https://pt-br.facebook.com/");
			...
			driver.findElement(By.cssSelector("input[name='sex'][value='2']")
                                     ).click();
			
			new Select(driver.findElement(By.name("birthday_day"))).selectByValue(
                            String.valueOf(day));

			new Select(driver.findElement(By.name("birthday_month"))
                            ).selectByValue(String.valueOf(mon));

			new Select(driver.findElement(By.name("birthday_year"))).selectByValue(
                            String.valueOf(year));
		}
	}
}