...
public class AgendaControllerIntegrationTest_testRestTemplate {
	...
	/*Limpa a tela de contatos e será executado depois de cada teste.*/
	@After public void end() {contatoRepository.deleteAll();}

	/*Neste verificam se ao fazer uma chamada para o endereço agenda,
	 *este irá retornar o status OK.*/
	@Test public void deveMostrarTodosContatos() 
	{	ResponseEntity<String> resposta = testRestTemplate.exchange(
				"/agenda/", HttpMethod.GET,null, String.class);
